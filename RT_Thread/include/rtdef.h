...
{
    void (*set_pixel) ( rt_uint8_t pixel, rt_uint32_t x, rt_uint32_t y);

    void (*draw_hline)(rt_uint8_t pixel, rt_uint32_t x_start, 
	                         rt_uint32_t x_end, rt_uint32_t y);
    void (*draw_vline)(rt_uint8_t pixel, rt_uint32_t x, 
	                         rt_uint32_t y_start, rt_uint32_t y_end);
  	void (*draw_block)(rt_uint8_t pixel, rt_uint32_t x_start, rt_uint32_t x_end, 
	                         rt_uint32_t y_start, rt_uint32_t y_end);
  	void (*draw_frame)(rt_uint8_t pixel, rt_uint32_t x_start,
                           rt_uint32_t x_end, rt_uint32_t y_start, rt_uint32_t y_end);
    void (*draw_chinese)(rt_uint8_t pixel, const rt_uint8_t * chr, 
			                     rt_uint32_t x, rt_uint32_t y);
	  void (*draw_char)(rt_uint8_t pixel, const rt_uint8_t * chr, rt_uint32_t x, rt_uint32_t y);
	  void (*draw_picture)(rt_uint8_t pixel, const rt_uint8_t * chr, 
	                            rt_uint32_t x, rt_uint32_t y,
